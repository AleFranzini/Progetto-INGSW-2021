...
class PurchaseDevelopmentCardTest {
    PurchaseDevelopmentCard purchaseDevelopmentCard;
    ...
    void setUp() {
        ...
        purchaseDevelopmentCard = new PurchaseDevelopmentCard();
        purchaseDevelopmentCard.takeCardToShow();
    }

    @Test
    void testBuyDevelopmentCard() throws EmptyCardSlotException, NotEnoughResourcesException {
        assertThrows(EmptyCardSlotException.class, () -> purchaseDevelopmentCard.getDevelopmentCardByID(5));
        assertThrows(NullPointerException.class, () -> purchaseDevelopmentCard.verifyPurchase(0));
    }
